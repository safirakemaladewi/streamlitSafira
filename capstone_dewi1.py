...
per tahun (kg) di Indonesia. Angka konsumsi ikan diperoleh dari jumlah konsumsi rumah tangga (Konsumsi Ikan Dalam Rumah 
Tangga, KIDRT), konsumsi luar rumah tangga, dan konsumsi tidak tercatat. 
"""
...
with st.expander("Histogram Konsumsi Ikan dan Pengeluaran per Kapita setiap Kabupaten/Kota di Indonesia"):
    st.write("""
    Berdasarkan grafik histogram yang ditampilkan serta uji normalitas diperoleh informasi bahwa kedua data tersebut tidak terdistribusi normal (p-value < 0,05). 
